...
<template>
	<link-item v-if="hasOneShowingChild(props.item.children, props.item) &&
		...
		<el-menu-item :index="resolvePath(onlyOneChild.path)" :class="{ 'submenu-title-noDropdown': !isNest }"
          ...
          " />
			...
			<el-text v-if="(!props.item?.meta.icon &&
			isCollapse &&
			layout === 'vertical' &&
		...
		" truncated class="!px-4 !text-inherit">
	...
	<el-sub-menu v-else ref="subMenu" teleported :index="resolvePath(props.item.path)" v-bind="expandCloseIcon">
		<template #title>
