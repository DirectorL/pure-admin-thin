...
<template>
	<div class="notice-container border-b-[1px] border-solid border-[#f0f0f0] dark:border-[#303030]">
		<el-avatar v-if="props.noticeItem.avatar" :size="30" :src="props.noticeItem.avatar"
		...
		<div class="notice-container-text">
			<div class="notice-text-title text-[#000000d9] dark:text-white">
				...
				<el-tag v-if="props.noticeItem?.extra" :type="props.noticeItem?.status" size="small"
			...
			<el-tooltip popper-class="notice-title-popper" :effect="tooltipEffect" :disabled="!descriptionTooltip"
				:content="props.noticeItem.description" placement="top-start">
