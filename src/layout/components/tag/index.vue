	...
	<div v-if="!showTags" ref="containerDom" class="tags-view">
		...
		<div ref="scrollbarDom" class="scroll-container" @wheel.prevent="handleWheel">
			<div ref="tabDom" class="tab select-none" :style="getTabStyle">
				<div v-for="(item, index) in multiTags" :ref="'dynamic' + index" :key="index"
		...
		<transition name="el-zoom-in-top">
			<ul v-show="visible" ref="contextmenuRef" :key="Math.random()" :style="getContextMenuStyle"
				class="contextmenu">
		...
		<el-dropdown trigger="click" placement="bottom-end" @command="handleCommand">
			...
			<template #dropdown>
				<el-dropdown-menu>
					<el-dropdown-item v-for="(item, key) in tagsViews" :key="key" :command="{ key, item }"
