...
<template>
	<panel>
		<div class="p-5">
			...
			<Segmented class="select-none" :modelValue="overallStyle === 'system' ? 2 : dataTheme ? 1 : 0"
				:options="themeOptions" @change="theme => {
			...
			<ul class="theme-color">
				<li v-for="(item, index) in themeColors" v-show="showThemeColors(item.themeColor)" :key="index"
			...
			<span v-if="useAppStoreHook().getViewportWidth > 1280">
				...
				<Segmented class="mb-2 select-none" :modelValue="isNumber(settings.stretch) ? 1 : 0"
				...
				<el-input-number v-if="isNumber(settings.stretch)" v-model="settings.stretch as number" :min="1280"
					:max="1600" controls-position="right" @change="value => setStretch(value)" />
			...
			<Segmented class="select-none" :modelValue="markValue === 'smart' ? 0 : 1" :options="markOptions"
				@change="onChange" />
			...
			<ul class="setting">
				<li>
					...
					<el-switch v-model="settings.greyVal" inline-prompt active-text="开" inactive-text="关"
						@change="greyChange" />
				</li>
				<li>
					<span class="dark:text-white">色弱模式</span>
					<el-switch v-model="settings.weakVal" inline-prompt active-text="开" inactive-text="关"
						@change="weekChange" />
				</li>
				<li>
					<span class="dark:text-white">隐藏标签页</span>
					<el-switch v-model="settings.tabsVal" inline-prompt active-text="开" inactive-text="关"
						@change="tagsChange" />
				</li>
				<li>
